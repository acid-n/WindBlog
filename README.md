# MUSSON Blog — Fullstack (Next.js + Django)\n\n[![Build Status](https://img.shields.io/github/actions/workflow/status/your-org/your-repo/ci.yml?branch=main)](https://github.com/your-org/your-repo/actions)\n[![Coverage Status](https://img.shields.io/codecov/c/github/your-org/your-repo/main.svg)](https://codecov.io/gh/your-org/your-repo)\n\n---\n\n## Описание\n\nMUSSON Blog — современный блог-проект с pixel-perfect frontend на Next.js (TypeScript, Tailwind, Framer Motion) и мощным backend на Django 5 (DRF, PostgreSQL, JWT, кастомная модель пользователя, SEO, OpenAPI). Полная поддержка Docker, CI/CD, строгая типизация, автотесты, покрытие >80%.\n\n- **Frontend:** [frontend/README.md](frontend/README.md) — Next.js 15.3.1, Tailwind CSS, TypeScript, Framer Motion, Jest, React Testing Library\n- **Backend:** [backend/README.md](backend/README.md) — Django 5, DRF, PostgreSQL, Pytest, JWT, OpenAPI/Swagger\n- **UX/UI STYLE GUIDE:** [docs/UX_UI_STYLE_GUIDE.txt](docs/UX_UI_STYLE_GUIDE.txt)\n\n---\n\n## Архитектура\n\n```\n┌────────────┐      HTTP(S)      ┌────────────┐      SQL      ┌─────────────┐\n│  Next.js   │  <----------->   │  Django    │  <------->   │ PostgreSQL  │\n│  frontend  │                  │  backend   │              │   DB        │\n└────────────┘                  └────────────┘              └─────────────┘\n```\n- **Типизация:** TypeScript (frontend), Pydantic/DRF (backend)\n- **CI/CD:** Docker, GitHub Actions, pre-commit хуки, автотесты, автосборка\n- **Документация API:** OpenAPI/Swagger (см. backend)\n\n---\n\n## Быстрый старт (Docker Compose)\n\n```bash\ngit clone https://github.com/your-org/your-repo.git\ncd your-repo\ncp .env.example .env # Заполнить переменные окружения\ncd docker\ncp .env.example .env # Для docker-compose\n# Запустить весь стек (frontend, backend, db)\ndocker-compose up --build\n```\n\n- Frontend: http://localhost:3000\n- Backend/API: http://localhost:8000/api/v1/\n- Swagger: http://localhost:8000/api/schema/\n\n---\n\n## Структура репозитория\n\n- `frontend/` — Next.js, Tailwind, компоненты, сервисы, тесты, Dockerfile, README.md\n- `backend/` — Django 5, DRF, приложения (blog, users, analytics, contact, seo), миграции, тесты, Dockerfile, README.md\n- `docker/` — docker-compose.yml, .env.example\n- `docs/UX_UI_STYLE_GUIDE.txt` — pixel-perfect гайд\n\n---\n\n## Документация и полезные ссылки\n\n- [Frontend README](frontend/README.md)\n- [Backend README](backend/README.md)\n- [UX/UI STYLE GUIDE](docs/UX_UI_STYLE_GUIDE.txt)\n- [OpenAPI/Swagger](http://localhost:8000/api/schema/) (после запуска backend)\n- [.env.example](docker/.env.example)\n\n---\n\n## FAQ\n- **Q:** Как добавить новый компонент?  \n  **A:** См. `frontend/src/components/`, следуйте style guide и типизации.\n- **Q:** Как запускать тесты?  \n  **A:** См. инструкции в frontend/backend README.\n- **Q:** Как деплоить?  \n  **A:** Используйте Docker или CI/CD pipeline (см. workflows).\n\n---\n\n## Контакты\n- Issues: [github.com/your-org/your-repo/issues](https://github.com/your-org/your-repo/issues)\n- Email: your@email.com\n
