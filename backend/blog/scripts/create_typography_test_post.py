...
body = {
    ...
    "content": [
        ...
        {"type": "bulletList", "content": [
            {"type": "listItem", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "Маркированный список — пункт 1"}]}]},
            {"type": "listItem", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "Маркированный список — пункт 2"}]}]}
        ]},
        {"type": "orderedList", "attrs": {"order": 1}, "content": [
            {"type": "listItem", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "Нумерованный список — пункт 1"}]}]},
            {"type": "listItem", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "Нумерованный список — пункт 2"}]}]}
        ]},
        ...
        {"type": "paragraph", "content": [
            ...
            {"type": "text", "marks": [{"type": "link", "attrs": {"href": "https://google.com", "target": "_blank"}}], "text": "Google"}
        ]},
