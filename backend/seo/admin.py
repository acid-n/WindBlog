...
from .models import GlobalSEOSettings, RobotsRule  # , OtherSEOModel if exists
...
class GlobalSEOSettingsAdmin(
    admin.ModelAdmin
):  # Замените на SingletonModelAdmin, если используется django-solo
    ...
    fieldsets = (
        ...
        ("Настройки robots.txt", {"fields": ("robots_crawl_delay",)}),
        (
