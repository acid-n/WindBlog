...
from seo.models import RobotsRule, GlobalSEOSettings
...
class TestRobotsTxtView:
    ...
    def test_robots_txt_with_rules_and_settings(self):
        ...
        RobotsRule.objects.create(user_agent="Googlebot", directive="Disallow", path="/private/")
        RobotsRule.objects.create(user_agent="YandexBot", directive="Disallow", path="/")
        RobotsRule.objects.create(user_agent="*", directive="Disallow", path="/cgi-bin/")
